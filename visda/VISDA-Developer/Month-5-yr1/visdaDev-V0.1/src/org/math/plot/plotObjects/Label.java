...
public class Label implements Plotable {
    ...
    public Label(String l, double[] c, Color col) {
        label = l;
        coord = c;
        color = col;
    }
    ...
    public Label(String l, double[] c) {
        this(l, c, AbstractDrawer.DEFAULT_COLOR);
    }
    ...
    public Label(double[] c) {
        this(coordToString(c), c, AbstractDrawer.DEFAULT_COLOR);
    }
    ...
    public void plot(AbstractDrawer draw) {
        ...
        draw.drawString(label, coord, angle, cornerE, cornerN);
