...
public abstract class PlotCanvas extends JPanel implements MouseListener, MouseMotionListener, ComponentListener, BaseDependant, MouseWheelListener {
    ...
    public int ActionMode = SELCENTER;
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        if ((mouseClick[0] == mouseCurent[0]) && (mouseClick[1] == mouseCurent[1])) {
            ...
            case SELCENTER:
            	...
            	// Plot newone = new Plot();  // why failed
            	/*Plot centerPlot = this.getPlot(0);
            	centerPlot.setData(centerData);
            	centerPlot.setColor(Color.PINK);
            	centerPlot.setName("Center");
            	addPlot(centerPlot);
            	getPlot(0).setData(orgData);
            	getPlot(0).setColor(Color.BLUE);
            	getPlot(0).setName("PCA Data");
            	break;*/
            }
        }
        mouseClick[0] = mouseCurent[0];
