 ...
 * 	visda_v0.2 (08/30/2005):  	Add view tree.
 * 	visda_v0.3 (09/29/2005):  	Add history log.								
 */
public class MainFrame extends JFrame {
    	...
    	public void actionPerformed(ActionEvent e) {
    		...
    		if (levelCnt < numLevels) {			
    			...
    			JOptionPane.showMessageDialog(new JFrame(),
    							    "The deepest level (set by configuration) has been reached. Cannot go deeper.",
    							    "warning",
    ...
    private class OpenRawAction extends AbstractAction {
        ...
        public void actionPerformed( ActionEvent ae ) {
            ...
            Dimension size = chooser.getPreferredSize(); // chooser window size
