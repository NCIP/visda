...
g++ $CFLAGS -c -o $OBJDIR/Plot2DViewer.o $SRCDIR/Plot2DViewer.cpp -I$INCDIR -I/opt/jdk1.5.0_04/include -I/opt/jdk1.5.0_04/include/linux
...
g++ $CFLAGS -shared -o $OUTDIR/libVISDA_CJavaInterface.so $OBJDIR/CFMCore.o $OBJDIR/DRMCore.o $OBJDIR/FeaturePreSelector.o $OBJDIR/Plot2DViewer.o  $OBJDIR/VISDA_CLib.a -lm -llapack -lpthread
