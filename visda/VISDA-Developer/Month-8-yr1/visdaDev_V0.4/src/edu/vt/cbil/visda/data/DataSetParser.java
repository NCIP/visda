...
/**
 * A Class to parse and populate DataSet implementors.  Data is expected to be simple, and
 * a tab-delimited data is organized into rows and columns with a row of column headers and
 * rows for sample annotations. 
 *   
 * For example:
 * <pre>
 * # this is a comment
...
public class DataSetParser {
     ...
     *
     * @param aFile 	an open inputStream
     * @param firstDataLocation 	location of the first data cell in the table
