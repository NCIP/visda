...
public class MultiPlotsViewer extends ViewerAdapter implements PropertyChangeListener {
    ...
    public MultiPlotsViewer(String title, Plot2DViewer multiPlots[],
    						ArrayList samples) {
        ...
        plotArea.setBorder(BorderFactory.createTitledBorder(title));
        //plotArea.setBackground(Color.white);
        //plotArea.setForeground(Color.black);
    ...
    private class LabelDisplayAction extends AbstractAction {
        ...
        public void actionPerformed( ActionEvent ae ) {
        	...
        	for(int i=0; i<plots.length; i++) {   
        		...
        		plots[i].plotPanel.plotCanvas.setActionMode(plots[i].plotPanel.plotCanvas.ANNOTATION);
        	}
        }
    }
