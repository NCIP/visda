...
cl /I"%HEADERDIR%" /I"%JAVA_HOME%\include" /I"%JAVA_HOME%\include\win32" /MD /nologo /W3 /GX /O2 /Fo"%OBJDIR%\\" /c %SRCDIR%\Plot2DViewer.cpp
...
link clapack.lib VISDA_CLib.lib /libpath:"%LIBDIR%" /nologo /dll /incremental:yes /out:"%OUTDIR%\VISDA_CJavaInterface.dll" %OBJDIR%/CFMCore.obj %OBJDIR%/DRMCore.obj %OBJDIR%/FeaturePreSelector.obj %OBJDIR%/Plot2DViewer.obj
